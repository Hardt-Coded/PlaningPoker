...
module StyleImports =
    ...
    let styled (component': string) (getStyles: Theme -> obj) : ('props -> 'a) =
...
type Styles =
    ...
    static member inline styled
        (component': string, getStyles: StyleCreator<'props> -> Theme -> 'a) : ('props -> 'a) =
        StyleImports.styled component' (getStyles (StyleCreator()) >> toPlainJsObj)

    static member inline styled
        (getStyles: StyleCreator<'props> -> Theme -> 'a) : ('props -> 'a) =
        StyleImports.styled "" (getStyles (StyleCreator()) >> toPlainJsObj)
