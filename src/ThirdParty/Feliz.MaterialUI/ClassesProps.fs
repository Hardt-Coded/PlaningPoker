...
module rec classesProps =
  ...
  module accordion =
    ...
    type classes =
      ...
      static member inline expandedSTATE(className: string) : IReactProperty = unbox ("classes.expandedSTATE", className)
      /// State class applied to the root element if `disabled={true}`.
      static member inline disabledSTATE(className: string) : IReactProperty = unbox ("classes.disabledSTATE", className)
  ...
  module accordionSummary =
    ...
    type classes =
      ...
      static member inline focusVisibleSTATE(className: string) : IReactProperty = unbox ("classes.focusVisibleSTATE", className)
      /// State class applied to the root element if `disabled={true}`.
      static member inline disabledSTATE(className: string) : IReactProperty = unbox ("classes.disabledSTATE", className)
      /// Styles applied to the root element unless `disableGutters={true}`.
      static member inline gutters(className: string) : IReactProperty = unbox ("classes.gutters", className)
  ...
  module autocomplete =
    ...
    type classes =
      ...
      static member inline focusedSTATE(className: string) : IReactProperty = unbox ("classes.focusedSTATE", className)
  ...
  module bottomNavigationAction =
    ...
    type classes =
      ...
      static member inline selectedSTATE(className: string) : IReactProperty = unbox ("classes.selectedSTATE", className)
  ...
  module checkbox =
    ...
    type classes =
      ...
      static member inline checkedSTATE(className: string) : IReactProperty = unbox ("classes.checkedSTATE", className)
      /// State class applied to the root element if `disabled={true}`.
      static member inline disabledSTATE(className: string) : IReactProperty = unbox ("classes.disabledSTATE", className)
  ...
  module filledInput =
    ...
    type classes =
      ...
      static member inline errorSTATE(className: string) : IReactProperty = unbox ("classes.errorSTATE", className)
  ...
  module formControlLabel =
    ...
    type classes =
      ...
      static member inline requiredSTATE(className: string) : IReactProperty = unbox ("classes.requiredSTATE", className)
  ...
  module inputBase =
    ...
    type classes =
      ...
      static member inline readOnlySTATE(className: string) : IReactProperty = unbox ("classes.readOnlySTATE", className)
      /// Styles applied to the input element.
      static member inline input(className: string) : IReactProperty = unbox ("classes.input", className)
      /// Styles applied to the input element if `size="small"`.
      static member inline inputSizeSmall(className: string) : IReactProperty = unbox ("classes.inputSizeSmall", className)
  ...
  module modal =
    ...
    type classes =
      ...
      static member inline backdrop(className: string) : IReactProperty = unbox ("classes.backdrop", className)
  ...
  module slider =
    ...
    type classes =
      ...
      static member inline activeSTATE(className: string) : IReactProperty = unbox ("classes.activeSTATE", className)
  ...
  module step =
    ...
    type classes =
      ...
      static member inline completedSTATE(className: string) : IReactProperty = unbox ("classes.completedSTATE", className)
  ...
  module timeline =
    ...
    type classes =
      ...
      static member inline positionAlternateReverse(className: string) : IReactProperty = unbox ("classes.positionAlternateReverse", className)
