...
type [<Erase>] accordion =
  ...
  static member inline expandedSTATE : string = ".Mui-expanded"
  /// State class applied to the root element if `disabled={true}`.
  static member inline disabledSTATE : string = ".Mui-disabled"
...
type [<Erase>] accordionSummary =
  ...
  static member inline focusVisibleSTATE : string = ".Mui-focusVisible"
  /// State class applied to the root element if `disabled={true}`.
  static member inline disabledSTATE : string = ".Mui-disabled"
  /// Styles applied to the root element unless `disableGutters={true}`.
...
type [<Erase>] autocomplete =
  ...
  static member inline focusedSTATE : string = ".Mui-focused"
...
type [<Erase>] bottomNavigationAction =
  ...
  static member inline selectedSTATE : string = ".Mui-selected"
...
type [<Erase>] checkbox =
  ...
  static member inline checkedSTATE : string = ".Mui-checked"
  /// State class applied to the root element if `disabled={true}`.
  static member inline disabledSTATE : string = ".Mui-disabled"
...
type [<Erase>] filledInput =
  ...
  static member inline errorSTATE : string = ".Mui-error"
  ...
  static member inline inputTypeSearch : string = ".MuiFilledInput-inputTypeSearch"
...
type [<Erase>] formControlLabel =
  ...
  static member inline requiredSTATE : string = ".Mui-required"
  /// Styles applied to the asterisk element.
  static member inline asterisk : string = ".MuiFormControlLabel-asterisk"
...
type [<Erase>] input =
  ...
  /// Styles applied to the input element if `startAdornment` is provided.
  static member inline inputAdornedStart : string = ".MuiInput-inputAdornedStart"
  /// Styles applied to the input element if `endAdornment` is provided.
  static member inline inputAdornedEnd : string = ".MuiInput-inputAdornedEnd"
  /// Styles applied to the input element if `type="search"`.
...
type [<Erase>] inputBase =
  ...
  static member inline readOnlySTATE : string = ".Mui-readOnly"
  /// Styles applied to the input element.
...
type [<Erase>] modal =
  ...
  static member inline backdrop : string = ".MuiModal-backdrop"
...
type [<Erase>] outlinedInput =
  ...
  /// Styles applied to the input element if `type="search"`.
  static member inline inputTypeSearch : string = ".MuiOutlinedInput-inputTypeSearch"
...
type [<Erase>] slider =
  ...
  static member inline activeSTATE : string = ".Mui-active"
...
type [<Erase>] step =
  ...
  static member inline completedSTATE : string = ".Mui-completed"
...
type [<Erase>] timeline =
  ...
  static member inline positionAlternateReverse : string = ".MuiTimeline-positionAlternateReverse"
...
type [<Erase>] timelineContent =
  ...
  /// Styles applied to the root element if `position="alternate-reverse"`.
  static member inline positionAlternateReverse : string = ".MuiTimelineContent-positionAlternateReverse"
...
type [<Erase>] timelineItem =
  ...
  /// Styles applied to the root element if `position="alternate-reverse"`.
  static member inline positionAlternateReverse : string = ".MuiTimelineItem-positionAlternateReverse"
...
type [<Erase>] timelineOppositeContent =
  ...
  /// Styles applied to the root element if `position="alternate-reverse"`.
  static member inline positionAlternateReverse : string = ".MuiTimelineOppositeContent-positionAlternateReverse"
