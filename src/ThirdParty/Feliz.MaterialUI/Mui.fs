...
type Mui =
  ...
  static member inline clickAwayListener props = createElement (import "ClickAwayListener" "@mui/base/ClickAwayListener") props

  static member inline clickAwayListener children = createElement (import "ClickAwayListener" "@mui/base/ClickAwayListener") [ clickAwayListener.children children ]
  ...
  static member inline portal props = createElement (import "Portal" "@mui/material") props

  static member inline portal (children: #seq<ReactElement>) = createElement (import "Portal" "@mui/material") [ portal.children (children :> seq<ReactElement>) ]
